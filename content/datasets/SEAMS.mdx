...
<figure style={{width: '300px', maxWidth: '100%', float: 'left'}}>
  <img src="/images/data/seams_star.png" alt="All surveys included in SEAMS." />
  <figcaption>Figure 1: All surveys included in SEAMS.</figcaption>
</figure>
...
<figure style={{width: '500px', maxWidth: '100%', float: 'right'}}>
  <img src="/images/data/seams_coverage_map.png" alt="SEAMS coverage map" />
  <figcaption>Figure 2: SEAMS coverage - Map of covered countries and number of integrated survey rounds per country.</figcaption>
</figure>
