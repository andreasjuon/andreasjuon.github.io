...
When we embark on the next logical step - and drill down to individual countries - democratic erosion becomes more visible and alarming, but remains mostly confined to specific democratic dimensions in specific places. For instance, we find that the rule of law deteriorated in Slovakia, Ukraine, and Bulgaria beginning around 2000, in Romania around 2012, and in Albania after 2011. Political competition narrowed sharply in Hungary in 2010, Romania in 2012, and Serbia in 2014. These are **real democratic setbacks, but based on our systematic data, they do not appear to be representative of a uniform regional crisis, at least by 2016**.
