...
headerImage: "/images/publications/cederman_etal2026_nationalist_geopolitics/InterstateConflict.webp"
previewImage: "/images/publications/cederman_etal2026_nationalist_geopolitics/InterstateConflict.webp"
date: "2026"
publicationType: peer-reviewed
authors: ["Lars-Erik Cederman", "Paola Galano Toro", "Luc Girardin","Andreas Juon","Julian Wucherpfennig"]
year: "2026"
...
publicationLinks:
  preprint: "/preprints/cederman_etal2026_nationalist_geopolitics.pdf"
  doi: "https://doi.org/10.1162/isec.a.416"
relatedItems: ["dominant_nationalism","epr"]
---

# The Return of Nationalist Geopolitics: Liberal Backsliding and Armed Conflict

**Why has political violence recently risen again after decades of decline which characterized much of the post-Cold War period? In our article in *International Security*, we argue that the answer lies not in a timeless, strategic logic of great-power competition, but in what we call the return of *nationalist geopolitics*: an ideologically driven wave of ethnic exclusion and irredentism that has been systematically eroding the institutional safeguards that once helped keep the peace.**
...
<Figure src="/images/publications/cederman_etal2026_nationalist_geopolitics/summary_exclusion_post1985.webp" caption="Figure 1. Domestic/state-internal developments since 1985: Trends in the share of ethnic groups' excluded from executive power (top panel) and in the incidence of ethnic civil war (bottom panel). Actual trends (solid line) juxtaposed to a counterfactual trend extrapolated from the post-Cold War period." align="left" width={300} />
...
<Figure src="/images/publications/cederman_etal2026_nationalist_geopolitics/summary_dyads_post1985.webp" caption="Figure 2. International/inter-state developments since 1985: Trends in the share of state-pairs where one state has ethnic kin that are politically excluded in another state (top panel) and in the incidence of interstate war and internationalized civil war (bottom panel). Actual trends (solid line) juxtaposed to a counterfactual trend extrapolated from the post-Cold War period." align="right" width={300} />
