...
import { getUpdatesPaginated, PAGE_SIZE_OPTIONS } from '@/lib/updates'
...
function UpdatesContent() {
  ...
  const { updates, total, totalPages, hasNext, hasPrev } = getUpdatesPaginated(page, pageSize)
  const effectivePageSize = pageSize === 'all' ? total : pageSize
  const start = (page - 1) * (pageSize === 'all' ? 1 : pageSize) + 1
